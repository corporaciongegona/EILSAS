      ...
      <div className='container-cards-section'>
         ...
         <div className='card-container'>
            <div className='card-section'>
               ...
               <p className='type'>Disponible en las ciudades: <br /> Bogota <br /> Cartagena *Proximo <br /> Neiva *próximo</p>
            </div>
            ...
            <div className='card-section'>
               ...
               <p className='description'>Marca: Martin Verdugo, Producto importado de España</p>
               <p className='type'>Disponible en las ciudades: Bogota <br /> Cartagena *Proximo <br /> Neiva *próximo</p>
            </div>
