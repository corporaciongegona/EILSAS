      ...
      <div className='container-cards-section'>
         ...
         <div className='card-container'>
            <div className='card-section'>
               ...
               <p className='type'>Disponible en las ciudades: <br /> Bogota <br /> Cartagena *Proximo <br /> Medellin *próximo</p>
            </div>
            ...
            <div className='card-section'>
               ...
               <p className='description'>Marca: Martin Verdugo, Producto importado de España</p>
               <p className='type'>Disponible en las ciudades: Bogota <br /> Cartagena *Proximo <br /> Medellin *próximo</p>
            </div>
         ...
         <div className='card-container'>
            <div className='card-section'>
               ...
               <p className='type'>Disponible en las ciudades: <br /> Bogota <br /> Cartagena <br /> Medellin <br />Santa Marta</p>
            </div>
         </div>
         ...
         <div className='card-container'>
            <div className='card-section'>
               ...
               <p className='type'>Disponible en las ciudades: <br /> Bogota <br /> Cartagena <br /> Medellin *próximo</p>
            </div>
         </div>
         ...
         <div className='card-container'>
            ...
            <div className='card-section'>
               ...
               <p className='type'>Disponible en las ciudades: <br /> Bogota <br /> Cartagena *próximo</p>
            </div>
